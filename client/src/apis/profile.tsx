...
export const getProfile = async () => {
  try {
    const profile = await axios.get('https://tasting-table.onrender.com/profile/');
...
export const getProfileByUserId = async (props: ProfileUserIdProps) => {
  ...
  try {
    const profile = await axios.get(`https://tasting-table.onrender.com/profile/${id}`);
...
export const editProfile = async (props: ProfileProps) => {
  try {
    const profile = await axios.put('https://tasting-table.onrender.com/profile/', { ...props });
...
export const createProfile = async (props: ProfileProps) => {
  try {
    const profile = await axios.post('https://tasting-table.onrender.com/profile/', { ...props });
