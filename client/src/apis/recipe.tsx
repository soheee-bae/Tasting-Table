...
export const getAllRecipes = async () => {
  try {
    const recipes = await axios.get('https://tasting-table.onrender.com/recipe/all');
...
export const getRecipeById = async (props: RecipeIdProps) => {
  const { id } = props;
  try {
    const recipes = await axios.get(`https://tasting-table.onrender.com/recipe/${id}`);
...
export const getRecipesByUserId = async (props: RecipeIdProps) => {
  const { id } = props;
  try {
    const recipes = await axios.get(`https://tasting-table.onrender.com/recipe/user/${id}`);
...
export const getRecipesByCategory = async (props: CategoryIdProps) => {
  const { id } = props;
  try {
    const recipes = await axios.get(`https://tasting-table.onrender.com/recipe/category/${id}`);
...
export const createRecipe = async (props: Recipe) => {
  try {
    const recipes = await axios.post('https://tasting-table.onrender.com/recipe/', { ...props });
...
export const editRecipe = async (props: RecipeProps) => {
  const { id, data } = props;
  try {
    const recipes = await axios.put(`https://tasting-table.onrender.com/recipe/${id}`, {
      ...data
    });
...
export const deleteRecipe = async (props: RecipeIdProps) => {
  ...
  try {
    const recipes = await axios.delete(`https://tasting-table.onrender.com/recipe/${id}`);
